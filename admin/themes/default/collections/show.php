...
<?php /* ?><h1><?php echo $collectionTitle; ?> <span class="view-public-page">[ <a href="<?php echo html_escape(public_uri('collections/show/'.collection('id'))); ?>"><?php echo __('View Public Page'); ?></a> ]</span> </h1><?php */ ?>
