...
$metadatarecordSql="INSERT INTO metadata_element_value (element_hierarchy, value, language_id, multi, record_id) VALUES ('6','".$title."','en',1, ".$last_record_id.")";
$execmetadatarecordSql=$db->query($metadatarecordSql);
$exec=null;

$metadatarecordSql="INSERT INTO metadata_element_value (element_hierarchy, value, language_id, multi, record_id) VALUES ('8','".$description."','en',1, ".$last_record_id.")";
$execmetadatarecordSql=$db->query($metadatarecordSql);
$exec=null;

$metadatarecordSql="INSERT INTO metadata_element_value (element_hierarchy, value, language_id, multi, record_id) VALUES ('32','".$_POST['identifier']."','none',1, ".$last_record_id.")";
$execmetadatarecordSql=$db->query($metadatarecordSql);
$exec=null;

$metadatarecordSql="INSERT INTO metadata_element_value (element_hierarchy, value, language_id, multi, record_id) VALUES ('33','".$_POST['format']."','none',1, ".$last_record_id.")";
$execmetadatarecordSql=$db->query($metadatarecordSql);
$exec=null;
...
if(strlen($_POST['Elements']['68']['0']['text'])>0){$path_title=$_POST['Elements']['68']['0']['text'];} else{$path_title="resource-title-".$max_id.""; $_POST['Elements']['68']['0']['text']="resource-title-".$max_id."";}
if($_POST['description']){$path_description=$_POST['description'];} else{$path_description="";}
...
$uri=WEB_ROOT;	
  if(stripos($data51['value'],".jpg")>0 or stripos($data51['value'],".gif")>0 or stripos($data51['value'],".jpeg")>0 or stripos($data51['value'],".png")>0 or stripos($data51['value'],".bmp")>0 or stripos($data51['value'],"content/thumbs/src")>0 or $dataformat['value']=="IMAGE"){
		   ...
		   }elseif(stripos($data51['value'],".doc")>0  or stripos($data51['value'],"docx")>0  or stripos($dataformat['value'],"word")>0){
		   
		   $string= '<img src="'.$uri.'/application/views/scripts/images/files-icons/word.png" width="'.$widththumb.'px; max-height:'.$widththumb.'px;"/><br>';
		   
		   }elseif(stripos($data51['value'],".ppt")>0 or stripos($data51['value'],".pptx")>0 or stripos($data51['value'],".pps")>0 or stripos($dataformat['value'],"powerpoint")>0){
		   ...
		   }elseif(stripos($data51['value'],"html")>0 or stripos($data51['value'],"htm")>0 or stripos($data51['value'],"asp")>0 or stripos($dataformat['value'],"HTML")>0 or stripos($dataformat['value'],"Html")>0 or $dataformat['value']=='html' or $dataformat['value']=='html/text' or $dataformat['value']=='HTML'){
