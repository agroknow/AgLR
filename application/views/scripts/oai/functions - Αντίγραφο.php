    ...
    if ($datageneral3['machine_name'] == 'rights') { ///////if RIGHTS
        ...
        foreach ($datageneral4 as $datageneral4) {
			...
			ON c.element_id = b.id  WHERE c.pelement_id=" . $datageneral4['elm_id'] . " and c.is_visible=1 ;";
                    ...
                    $thereturn .= '<taxonPath>' . "\n";
                    $thereturn .= '<source>' . "\n";
                    $thereturn .= xmlformat('Organic.Edunet Ontology', 'string', ' language="en"', $indent);
                    $thereturn .= '</source>' . "\n";
                    $thereturn .= '<taxon>' . "\n";
                    $thereturn .= xmlformat($taxon_id_value, 'id', '', $indent);
                    $thereturn .= '<entry>' . "\n";
                    $thereturn .= xmlformat($taxon_entry, 'string', '', $indent);
                    $thereturn .= '</entry>' . "\n";
                    $thereturn .= '</taxon>' . "\n";
                    $thereturn .= '</taxonPath>' . "\n";
                }//foreach($datageneral8 as $datageneral8){
...
$previousmulti=0;
    ...
    if ($datageneral4['machine_name'] == 'title') {
        ...
        foreach ($datageneral5 as $datageneral5) {
            ...
            $output.=xmlformat($datageneral5['value'], 'string', 'language="' . $datageneral5['language_id'] . '" ', $indent);
    ...
    if ($datageneral4['datatype_id'] == 1) {
        ...
        foreach ($datageneral5 as $datageneral5) {
            ...
            if (strlen($datageneral10['name']) > 0 or strlen($datageneral10['surname']) > 0) {
                $name = "N:" . $datageneral10['surname'] . ";" . $datageneral10['name'] . "";
            } else {
                $name = '';
            }
